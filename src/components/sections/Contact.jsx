...
export function Contact() {
  ...
  return (
    <section id="contact" className="md:my-40 mb-20 sm:mb-32 text-center flex flex-col gap-5 bg-neutral-950/35 rounded-xl border border-neutral-500/20 shadow-[0_0_6px_0_black] py-7 md:py-14 px-1.5">
