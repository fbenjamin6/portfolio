...
export function ProjectCard({ name, description, imgSrc, code, website, techs, t }) {
  return (
    <article className="p-2.5 md:p-6 flex flex-col lg:flex-row gap-2.5 flex-nowrap bg-neutral-950/35 rounded-xl border border-neutral-500/20 shadow-[0_0_6px_0_black]">
      ...
      <div className="relative rounded-xl overflow-hidden  border group border-neutral-500/30 shadow-[0_0_4px_0_black] cursor-pointer  lg:w-1/2 ">
        <a href={website} target="_blank">
          <img src="/imgs/projectBackground.webp" className="absolute w-full h-full z-0 " alt="Violet and pink background gradient" />
          <img src={imgSrc} className=" relative z-10 translate-x-[10%] translate-y-[10%] group-hover:translate-x-[1px] group-hover:translate-y-0 transition-all  duration-300 ease-in-out scale-90 group-hover:scale-100" alt="preview of a web project" />
        </a>
      </div>
    </article>
  )
